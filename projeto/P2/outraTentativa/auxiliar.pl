...
% http://stackoverflow.com/questions/8519203/prolog-replace-anelement-in-a-list-at-a-specified-index
...
/*convert binary list into integer (code retrieved from):
http://stackoverflow.com/questions/27788739/binary-to-decimalprolog*/
binary_number(Bs0, N) :-
 reverse(Bs0, Bs),
